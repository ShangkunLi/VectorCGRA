...
mkdir -p log reports summaryReport timingReports enc def reports/layout
...
"${INNOVUS_BIN}" -64 -overwrite -log log/innovus_grid.log -files scripts/run_innovus_grid.tcl
