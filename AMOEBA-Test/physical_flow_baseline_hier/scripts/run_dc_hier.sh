...
python3 scripts/prepare_hier_rtl.py \
  --rtl ../generated/BaselineMultiCgra4x4Cgra2x2RTL.v \
  --work-dir ./work \
  --top-only-rtl ./work/baseline_top_without_core.v \
  --module-names-tcl ./work/module_names.tcl

"${DC_BIN}" -64bit -f scripts/synth_core_dc.tcl | tee log/dc_core.log
require_file ./block_handoff/baseline_cgra_core.v "core DC"
require_file ./block_handoff/baseline_cgra_core.ddc "core DC"
require_file ./block_handoff/baseline_cgra_core.sdc "core DC"
...
require_file ./syn_handoff/baseline.v "top DC"
require_file ./syn_handoff/baseline.sdc "top DC"
require_file ./results/baseline.ddc "top DC"
require_file ./reports/dc_area.rpt "top DC"
require_file ./reports/dc_timing.rpt "top DC"

echo "Hierarchical DC handoff is ready: syn_handoff/baseline.v and syn_handoff/baseline.sdc"
