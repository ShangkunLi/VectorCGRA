...
require_file ./syn_handoff/baseline.v "hierarchical DC"
require_file ./syn_handoff/baseline.sdc "hierarchical DC"
...
python3 scripts/write_blackbox_top_netlist.py \
  --netlist ./syn_handoff/baseline.v \
  --module-names-tcl ./work/module_names.tcl \
  --output ./syn_handoff/baseline_top_macro.v
require_file ./syn_handoff/baseline_top_macro.v "top macro netlist preparation"

"${INNOVUS_BIN}" -64 -overwrite -log log/innovus_core.log -files scripts/run_core_innovus.tcl
require_file ./block_handoff/baseline_cgra_core.lef "core Innovus"
require_file ./block_handoff/baseline_cgra_core.def "core Innovus"
...
require_file ./def/top_macro/baseline.def "top macro Innovus"
require_file ./def/top_macro/BaselineMultiCgra4x4Cgra2x2RTL_post_route.v "top macro Innovus"
...
if [ -f def/top_macro/baseline.def ]; then
  python3 scripts/export_def_layout_svg.py \
    --def-file def/top_macro/baseline.def \
    --output reports/baseline_macro_layout.svg \
    --title "Baseline 4x4 Multi-CGRA Macro-Level Post-Route Layout"
fi
require_file ./reports/baseline_macro_layout.svg "DEF-to-SVG exporter"

echo "Hierarchical Innovus flow is ready: reports/baseline_macro_layout.svg"
